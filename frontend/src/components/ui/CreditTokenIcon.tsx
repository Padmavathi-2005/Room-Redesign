...
export function CreditTokenIcon({
  ...
  const reactId = useId();
  const id = `gold_${reactId.replace(/[^a-zA-Z0-9_-]/g, '_')}`;
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}_bright`} x1="50" y1="50" x2="450" y2="450" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id={`${id}_dark`} x1="0" y1="0" x2="512" y2="512" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id={`${id}_bevel`} x1="100" y1="80" x2="400" y2="400" gradientUnits="userSpaceOnUse">
